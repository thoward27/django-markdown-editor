  ...
  $.fn.martor = function () {
    ...
    this.each(function (i, obj) {
      ...
      var editorConfig = JSON.parse(
        textareaId.data("enable-configs").replace(/'/g, '"'),
      );
      ...
      var currentTab = $(
        ".tab.segment[data-tab=preview-tab-" + field_name + "]",
      );
      var previewTabButton = $(
        ".item[data-tab=preview-tab-" + field_name + "]",
      );
      ...
      var markdownToImageLink = function (editor, imageData) {
        ...
        if (typeof imageData === "undefined") {
          ...
          // this if use image upload to imgur.
          var curpos = editor.getCursorPosition();
          editor.session.insert(
            curpos,
            "![" + imageData.name + "](" + imageData.link + ") ",
          );
          editor.focus();
          editor.selection.moveTo(
            curpos.row,
      ...
      var markdownToEmoji = function (editor, data_target) {
        ...
        editor.selection.moveTo(
          curpos.row,
          curpos.column + data_target.length + 2,
        );
      };
      ...
      // Trigger Click
      $(".markdown-bold[data-field-name=" + field_name + "]").click(
        function () {
          markdownToBold(editor);
        },
      );
      $(".markdown-italic[data-field-name=" + field_name + "]").click(
        function () {
          markdownToItalic(editor);
        },
      );
      $(".markdown-horizontal[data-field-name=" + field_name + "]").click(
        function () {
          markdownToHorizontal(editor);
        },
      );
      ...
      $(".markdown-code[data-field-name=" + field_name + "]").click(
        function () {
          markdownToCode(editor);
        },
      );
      $(".markdown-blockquote[data-field-name=" + field_name + "]").click(
        function () {
          markdownToBlockQuote(editor);
        },
      );
      $(".markdown-unordered-list[data-field-name=" + field_name + "]").click(
        function () {
          markdownToUnorderedList(editor);
        },
      );
      $(".markdown-ordered-list[data-field-name=" + field_name + "]").click(
        function () {
          markdownToOrderedList(editor);
        },
      );
      $(".markdown-link[data-field-name=" + field_name + "]").click(
        function () {
          markdownToLink(editor);
        },
      );
      $(".markdown-image-link[data-field-name=" + field_name + "]").click(
        function () {
          markdownToImageLink(editor);
        },
      );
      ...
      var btnMention = $(
        ".markdown-direct-mention[data-field-name=" + field_name + "]",
      ); // To Direct Mention
      var btnUpload = $(
        ".markdown-image-upload[data-field-name=" + field_name + "]",
      ); // To Upload Image
      ...
      $(".markdown-help[data-field-name=" + field_name + "]").click(
        function () {
          $(".modal-help-guide[data-field-name=" + field_name + "]").modal(
            "show",
          );
        },
      );
      ...
      var btnToggleMaximize = $(
        ".markdown-toggle-maximize[data-field-name=" + field_name + "]",
      );
      ...
      var handleToggleMaximize = function (selector) {
        ...
        preview.attr({
          style: "overflow-y: auto;height:" + clientHeight + "px",
        });
      ...
      $(".markdown-emoji[data-field-name=" + field_name + "]").click(
        function () {
          var modalEmoji = $(
            ".modal-emoji[data-field-name=" + field_name + "]",
          );
            ...
            .modal({
              onVisible: function () {
                for (var i = 0; i < emojiList.length; i++) {
                  var linkEmoji =
                    textareaId.data("base-emoji-url") +
                    emojiList[i].replace(/:/g, "") +
                    ".png";
                  segmentEmoji.append(
                    "" +
                      '<div class="four wide column">' +
                      '<p><a data-emoji-target="' +
                      emojiList[i] +
                      '" class="insert-emoji">' +
                      '<img class="marked-emoji" src="' +
                      linkEmoji +
                      '"> ' +
                      emojiList[i] +
                      "</a></p>" +
                  ...
                  $('a[data-emoji-target="' + emojiList[i] + '"]').click(
                    function () {
